    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx('span', {
            className: cn('text-xs ml-auto', theme.textMuted),
            children: timeAgo(task.created_at),
          }),
          _jsx('span', {
          ...
          _jsxs('span', {
            ...
            children: ['d', task.call_depth],
          }),
        ],
      }),
      _jsx('p', {
        className: cn('text-xs mt-1.5 truncate', theme.textMuted),
        children: task.task_prompt,
      }),
          ...
          _jsxs('div', {
            ...
            children: [
              ...
              _jsx('button', {
                ...
                title: 'Refresh',
                children: _jsx(RefreshCw, { width: 16, height: 16 }),
              }),
            ],
          }),
        ],
      ...
      !isLoading &&
        ...
        _jsx('div', {
          ...
          children: tasks.map((task) =>
            _jsx(TaskRow, { task: task, theme: theme }, task.id),
          ),
        }),
    ],
  });
