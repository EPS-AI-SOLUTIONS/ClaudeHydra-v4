            ...
            _jsxs(motion.div, {
              ...
              children: [
                _jsxs('div', {
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        _jsxs('div', {
                          children: [
                            ...
                            _jsxs('p', {
                              className: cn('text-xs', isLight ? 'text-slate-500' : 'text-white/50'),
                              children: [
                                'GeminiHydra Session ',
                    ...
                    _jsx('button', {
                      ...
                      children: _jsx(X, { size: 18, className: isLight ? 'text-slate-600' : 'text-white/60' }),
                    }),
                  ],
                }),
                _jsxs('div', {
                  ...
                  children: [
                    isLoading &&
                      _jsx('div', {
                        ...
                        children: _jsx(Loader2, { size: 24, className: 'animate-spin text-blue-500' }),
                      }),
                    error &&
                      _jsx('div', {
                        className: cn('text-center py-8 text-sm', isLight ? 'text-red-600' : 'text-red-400'),
                        ...
                        'div',
                        {
                          ...
                          children: [
                            _jsx('div', {
                              ...
                              children: msg.role === 'user' ? _jsx(User, { size: 14 }) : _jsx(Bot, { size: 14 }),
                            }),
                            _jsxs('div', {
                              className: cn(
                              ...
                              children: [
                                ...
                                _jsxs('div', {
                                  ...
                                  children: [
                                    msg.model &&
                                      _jsx('span', { className: 'text-[10px] font-mono', children: msg.model }),
                                    _jsx('span', { className: 'text-[10px]', children: formatTime(msg.timestamp) }),
                                  ],
                                }),
                              ],
                            }),
                ...
                _jsx('div', {
                  ...
                  children: _jsx('span', {
                    className: cn('text-xs', isLight ? 'text-slate-400' : 'text-white/30'),
