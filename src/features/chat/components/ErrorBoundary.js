      ...
      return _jsxs('div', {
        ...
        children: [
          _jsx('div', {
            ...
            children: _jsx(AlertTriangle, { className: 'w-8 h-8 text-red-400' }),
          }),
          _jsxs('div', {
            ...
            children: [
              _jsxs('h3', {
                ...
                children: ['Co\u015B posz\u0142o nie tak ', this.props.name ? `w ${this.props.name}` : ''],
              }),
              _jsx('p', {
                className: 'text-sm text-red-400/80 break-words font-mono bg-black/40 p-2 rounded',
          ...
          _jsxs(Button, {
            ...
            children: [_jsx(RefreshCcw, { className: 'w-4 h-4 mr-2' }), 'Spr\u00F3buj ponownie'],
          }),
        ],
      });
    }
