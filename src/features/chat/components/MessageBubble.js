import { splitToolOutput, stripParallelHeader, useViewTheme } from '@jaskier/chat-module';
...
export const MessageBubble = memo(({ message, isLast, isStreaming, onContextMenu, onRetry }) => {
      ...
      children: [
        _jsx('div', {
          ...
          children: _jsx(BaseMessageBubble, {
            ...
            avatar: message.role === 'assistant' ? _jsx(AgentAvatar, { state: status }) : undefined,
            copyText: t('chat.copyMessage', 'Copy message'),
            copiedText: t('common.copied', 'Copied'),
            modelBadge: message.model,
            toolInteractions:
              toolSegments.length > 0
                ? _jsx(ToolResultRenderer, { segments: toolSegments, isLight: theme.isLight })
                : undefined,
          }),
        }),
        isError &&
          ...
          _jsx('div', {
            ...
            children: _jsxs('button', {
              ...
              children: [_jsx(RefreshCw, { size: 12 }), t('chat.retry', 'Retry')],
            }),
          }),
        !isStreaming &&
          ...
          _jsx('div', {
            ...
            children: _jsx(MessageRating, { sessionId: currentSessionId, messageId: message.id }),
          }),
      ],
    }),
  });
