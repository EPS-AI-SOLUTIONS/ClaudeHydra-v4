          ...
          children: [
            _jsxs('summary', {
              ...
              children: [
                ...
                _jsx('span', { children: t('chat.toolLabel', { name: segment.name }) }),
                _jsx('span', {
                  className: 'ml-auto text-[10px]',
                  children: t('chat.linesCount', { count: segment.content.split('\n').length }),
                }),
              ],
            }),
            _jsx('pre', {
              className: cn('overflow-x-auto px-3 py-2 text-xs border-t max-h-60 overflow-y-auto', preClasses),
