...
function EmptyChatState({ onSuggestionSelect }) {
  ...
  return _jsxs(motion.div, {
    ...
    children: [
      ...
      _jsx(PromptSuggestions, { suggestions: CH_SUGGESTIONS, onSelect: onSuggestionSelect }),
    ],
  });
}
// ---------------------------------------------------------------------------
            ...
            return _jsx(
              'div',
              {
                ...
                children: _jsxs('div', {
                  ...
                  children: [
                    _jsx('div', { className: 'flex-1 h-px bg-[var(--matrix-accent)]/30' }),
                    _jsxs('div', {
                      className: 'flex items-center gap-2',
                      children: [
                        _jsx('span', {
                          className: 'text-xs font-mono text-[var(--matrix-accent)]/70',
                          children: t('chat.compaction.divider', 'Starsze wiadomości skompresowane'),
                        }),
                        onLoadFullHistory &&
                          _jsx('button', {
                            type: 'button',
                            ...
                            children: t('chat.compaction.loadFull', 'Załaduj pełną historię'),
                          }),
                      ],
                    }),
                    _jsx('div', { className: 'flex-1 h-px bg-[var(--matrix-accent)]/30' }),
      ...
      _jsx(AnimatePresence, {
        children:
          ...
          _jsxs(motion.button, {
            ...
            children: [_jsx(ArrowDown, { size: 14 }), t('chat.newMessages', 'New messages')],
          }),
      }),
    ],
  });
