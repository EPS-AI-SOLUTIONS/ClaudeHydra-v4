    ...
    children: _jsxs(motion.div, {
      ...
      children: [
        _jsxs('div', {
          ...
          children: [
            _jsx(ScrollText, { size: 22, className: 'text-[var(--matrix-accent)]' }),
            _jsx('h1', {
        ...
        _jsx(Card, {
          children: _jsxs('div', {
            ...
            children: [
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsxs('select', {
                    ...
                    children: [
                      _jsx('option', { value: '', children: t('logs.allLevels', 'All levels') }),
                  ...
                  _jsx(Button, {
                    ...
                    leftIcon: _jsx(RefreshCw, { size: 14, className: autoRefresh ? 'animate-spin' : '' }),
              ...
              isLoading &&
                _jsx('p', {
                  className: 'text-sm text-[var(--matrix-text-secondary)] text-center py-8',
                  ...
                  children: logs.map((entry, i) =>
                    _jsxs(
                      'div',
                      {
                        ...
                        children: [
                          _jsx('span', {
                            className: 'font-mono text-xs text-[var(--matrix-text-secondary)] shrink-0 pt-0.5 w-20',
                          ...
                          _jsx('span', {
                            className: 'font-mono text-xs text-[var(--matrix-text-primary)] flex-1 break-all',
