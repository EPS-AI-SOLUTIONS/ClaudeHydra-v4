...
function AgentNode({ data }) {
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsxs('div', {
        style: { display: 'flex', alignItems: 'center', gap: '8px', fontWeight: 'bold', marginBottom: '8px' },
        children: [_jsx(Bot, { size: 16, color: '#60a5fa' }), data.label],
      }),
      _jsxs('div', { style: { color: '#94a3b8', fontSize: '10px' }, children: ['Model: ', data.model || 'Unknown'] }),
...
function McpNode({ data }) {
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsxs('div', {
        style: { display: 'flex', alignItems: 'center', gap: '8px', fontWeight: 'bold', marginBottom: '8px' },
        children: [_jsx(Wrench, { size: 16, color: '#facc15' }), data.label],
      }),
      _jsxs('div', { style: { color: '#94a3b8', fontSize: '10px' }, children: ['Server: ', data.server || 'Local'] }),
      _jsx(Handle, { type: 'source', position: Position.Bottom }),
    ],
  });
}
function DbNode({ data }) {
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsxs('div', {
        style: { display: 'flex', alignItems: 'center', gap: '8px', fontWeight: 'bold', marginBottom: '8px' },
        children: [_jsx(Database, { size: 16, color: '#4ade80' }), data.label],
      }),
      _jsxs('div', { style: { color: '#94a3b8', fontSize: '10px' }, children: ['Type: ', data.dbType || 'SQL'] }),
      _jsx(Handle, { type: 'source', position: Position.Bottom }),
    ],
  });
}
function SandboxNode({ data }) {
  return _jsxs('div', {
    style: { ...nodeStyle, border: '2px solid #10b981', background: '#0f2e1f' },
    children: [
      _jsx(Handle, { type: 'target', position: Position.Top }),
      _jsxs('div', {
        style: { display: 'flex', alignItems: 'center', gap: '8px', fontWeight: 'bold', marginBottom: '8px' },
        children: [_jsx(Shield, { size: 16, color: '#10b981' }), data.label],
      }),
      _jsxs('div', {
        style: { color: '#94a3b8', fontSize: '10px' },
        children: [data.language || 'node', ' \u00B7 ', data.isolated ? 'Docker' : 'Process'],
      }),
      _jsx('div', {
        style: {
          color: '#10b981',
...
function MediaEdge({ id, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, style = {}, markerEnd }) {
  ...
  return _jsxs(_Fragment, {
    children: [
      _jsx(BaseEdge, { path: edgePath, markerEnd: markerEnd, style: style, id: id }),
      _jsx(EdgeLabelRenderer, {
        children: _jsx('div', {
          ...
          children: _jsx(ImageIcon, { size: 12, color: '#60a5fa' }),
        }),
      }),
    ],
  });
...
function Sidebar() {
  return _jsxs('div', {
    ...
    children: [
      _jsx('div', {
        style: { fontSize: '14px', fontWeight: 'bold', color: '#e2e8f0', marginBottom: '16px' },
        children: 'Toolbox',
      }),
      _jsx('div', {
        style: { fontSize: '11px', color: '#94a3b8', marginBottom: '8px', textTransform: 'uppercase' },
        children: 'Agents',
      }),
      _jsxs(DraggableItem, {
        nodeType: 'agent',
        ...
        children: [_jsx(Bot, { size: 14, color: '#60a5fa' }), ' Claude'],
      }),
      _jsxs(DraggableItem, {
        nodeType: 'agent',
        label: 'DeepSeek Agent',
        extraData: { model: 'deepseek-coder', peerId: 'deepseekhydra' },
        children: [_jsx(Bot, { size: 14, color: '#60a5fa' }), ' DeepSeek'],
      }),
      _jsxs(DraggableItem, {
        nodeType: 'agent',
        label: 'Gemini Agent',
        extraData: { model: 'gemini-1.5-pro', peerId: 'geminihydra' },
        children: [_jsx(Bot, { size: 14, color: '#60a5fa' }), ' Gemini'],
      }),
      _jsxs(DraggableItem, {
        nodeType: 'agent',
        label: 'Grok Agent',
        extraData: { model: 'grok-beta', peerId: 'grokhydra' },
        children: [_jsx(Bot, { size: 14, color: '#60a5fa' }), ' Grok'],
      }),
      _jsxs(DraggableItem, {
        nodeType: 'agent',
        label: 'OpenAI Agent',
        extraData: { model: 'gpt-4o', peerId: 'openaihydra' },
        children: [_jsx(Bot, { size: 14, color: '#60a5fa' }), ' OpenAI'],
      }),
      _jsx('div', {
        style: {
          fontSize: '11px',
      ...
      _jsxs(DraggableItem, {
        ...
        children: [_jsx(Wrench, { size: 14, color: '#facc15' }), ' Playwright'],
      }),
      _jsxs(DraggableItem, {
        nodeType: 'mcp',
        label: 'Repomix MCP',
        extraData: { server: 'repomix' },
        children: [_jsx(Wrench, { size: 14, color: '#facc15' }), ' Repomix'],
      }),
      _jsx('div', {
        style: {
          fontSize: '11px',
      ...
      _jsxs(DraggableItem, {
        ...
        children: [_jsx(Database, { size: 14, color: '#4ade80' }), ' Postgres'],
      }),
      _jsxs(DraggableItem, {
        nodeType: 'database',
        label: 'Qdrant Vector',
        extraData: { dbType: 'Vector DB' },
        children: [_jsx(Database, { size: 14, color: '#4ade80' }), ' Qdrant'],
      }),
      _jsx('div', {
        style: {
          fontSize: '11px',
      ...
      _jsxs(DraggableItem, {
        ...
        children: [_jsx(Shield, { size: 14, color: '#10b981' }), ' Node.js'],
      }),
      _jsxs(DraggableItem, {
        nodeType: 'sandbox',
        label: 'Python Sandbox',
        extraData: { language: 'python', isolated: true },
        children: [_jsx(Shield, { size: 14, color: '#10b981' }), ' Python'],
      }),
      _jsxs(DraggableItem, {
        nodeType: 'sandbox',
        label: 'Bash Sandbox',
        extraData: { language: 'bash', isolated: true },
        children: [_jsx(Shield, { size: 14, color: '#10b981' }), ' Bash'],
      }),
    ],
  });
}
...
export function SwarmBuilder({ events = [] }) {
  ...
  const handleExecute = async () => {
    ...
    const agentNodes = currentNodes.filter((n) => n.type === 'agent' && n.data?.['peerId']);
    ...
    const connectedEdges = currentEdges.filter((e) => agentNodes.some((n) => n.id === e.source || n.id === e.target));
    setEdges((eds) =>
      eds.map((e) => ({
        ...e,
        animated: connectedEdges.some((ce) => ce.id === e.id),
        style: { stroke: connectedEdges.some((ce) => ce.id === e.id) ? '#3b82f6' : '#334155', strokeWidth: 2 },
      })),
    );
    try {
                ...
                children: _jsxs('div', {
                  ...
                  children: [
                    _jsxs('button', {
                      ...
                      children: [_jsx(Save, { size: 14 }), 'Save'],
                    }),
                    _jsxs('button', {
                      type: 'button',
                      ...
                      children: [_jsx(Download, { size: 14 }), 'Export'],
                    }),
                    _jsxs('button', {
                      type: 'button',
                      ...
                      children: [
                        isRunning ? _jsx(Bot, { size: 14, className: 'animate-pulse' }) : _jsx(Play, { size: 14 }),
