          ...
          _jsxs('div', {
            ...
            children: [
              _jsxs('div', {
                ...
                children: [
                  _jsx(Shield, { size: 16, color: '#10b981' }),
                  _jsx('span', { style: { fontSize: '13px', fontWeight: 600, color: '#e2e8f0' }, children: 'Sandbox' }),
                ],
              }),
              ...
              _jsxs('div', {
                ...
                children: [
                  _jsx(Container, { size: 14, color: health?.docker_available ? '#22c55e' : '#f59e0b' }),
                  _jsx('span', {
              ...
              _jsxs('button', {
                ...
                children: [_jsx(Box, { size: 12 }), 'Sessions (', sessions.length, ')'],
              }),
            ],
          }),
          _jsxs('div', {
            ...
            children: [
              ...
              _jsxs('button', {
                ...
                children: [
                  isCreating ? _jsx(Loader2, { size: 12, className: 'animate-spin' }) : _jsx(Plus, { size: 12 }),
                  'New Session',
                ],
              }),
            ],
                ...
                children: [
                  _jsx('button', {
                    ...
                    children: isExecuting
                      ? _jsxs(_Fragment, {
                          children: [_jsx(Loader2, { size: 14, className: 'animate-spin' }), 'Running...'],
                        })
                      : _jsxs(_Fragment, { children: [_jsx(Play, { size: 14 }), 'Run (Ctrl+Enter)'] }),
                  }),
                  _jsxs('span', {
                    style: { fontSize: '11px', color: '#64748b' },
                    children: [
        ...
        children:
          ...
          _jsx(motion.div, {
            ...
            children: _jsxs('div', {
              ...
              children: [
                _jsx('div', {
                  style: { fontSize: '13px', fontWeight: 600, color: '#e2e8f0', marginBottom: '10px' },
                  children: 'Sandbox Sessions',
                }),
                sessions.length === 0
                  ? _jsx('div', {
                      style: { fontSize: '12px', color: '#64748b', textAlign: 'center', padding: '20px 0' },
                      children: 'No active sessions. Click "New Session" to create one.',
                    })
                ...
                executions.slice(0, 20).map((exec) => _jsx(ExecutionRow, { execution: exec }, exec.id)),
              ],
            }),
          }),
      }),
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          isSuccess
            ? _jsx(CheckCircle2, { size: 14, color: '#22c55e' })
            : isTimeout
              ? _jsx(Clock, { size: 14, color: '#f59e0b' })
              : _jsx(XCircle, { size: 14, color: '#ef4444' }),
          _jsx('span', {
            style: {
              fontSize: '12px',
              fontWeight: 600,
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              ...
              _jsx('span', {
                style: { fontSize: '12px', color: '#e2e8f0', fontWeight: isActive ? 600 : 400 },
      ...
      _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              isSuccess
                ? _jsx(CheckCircle2, { size: 10, color: '#22c55e' })
                : _jsx(XCircle, { size: 10, color: '#ef4444' }),
              _jsx('span', {
                style: {
                  fontSize: '10px',
                  fontWeight: 700,
          ...
          _jsxs('span', { style: { fontSize: '10px', color: '#64748b' }, children: [execution.duration_ms, 'ms'] }),
        ],
      }),
      _jsxs('div', {
        style: {
        ...
        children: [execution.code.slice(0, 60), execution.code.length > 60 && '...'],
      }),
    ],
  });
}
