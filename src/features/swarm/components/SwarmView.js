    ...
    children: [
        ...
        children: [
          _jsxs('button', {
            ...
            style: {
              ...
              borderRadius: '6px',
              background:
                activeTab === 'monitoring' ? '#1e293b' : 'transparent',
            ...
            children: [
              _jsx(Activity, { width: 16, height: 16 }),
              ' ',
              t('swarm.tabs.monitoring'),
            ],
          }),
          _jsxs('button', {
            type: 'button',
            ...
            children: [
              _jsx(LayoutTemplate, { width: 16, height: 16 }),
              ' ',
              t('swarm.tabs.builder'),
            ],
          }),
          _jsxs('button', {
            type: 'button',
            ...
            children: [
              _jsx(Shield, { width: 16, height: 16 }),
              ' ',
              t('swarm.tabs.sandbox'),
            ],
          }),
          _jsxs('button', {
            type: 'button',
            ...
            children: [
              _jsx(Brain, { width: 16, height: 16 }),
              ' ',
              t('swarm.tabs.pruning'),
            ],
          }),
        ],
      }),
      activeTab === 'pruning'
        ? _jsx('div', {
            ...
            children: _jsx(MemoryPruningPanel, {}),
          })
        : activeTab === 'sandbox'
          ? _jsx('div', {
              style: { flex: 1, minHeight: 0 },
              children: _jsx(SandboxPanel, {}),
            })
          : activeTab === 'builder'
            ? _jsx('div', {
                style: { flex: 1, minHeight: 0 },
                children: _jsx(SwarmBuilder, { events: events }),
              })
            : _jsxs('div', {
                          ...
                          _jsx(Panel, {
                            ...
                            children: _jsxs('div', {
                              ...
                              children: [
                                ...
                                _jsx(Stat, {
                                  icon: _jsx(Globe, { width: 14, height: 14 }),
                                ...
                                _jsxs('button', {
                                  type: 'button',
                                  onClick: () =>
                                    setShowDelegatePanel(!showDelegatePanel),
                                  style: {
                                    display: 'flex',
                                    alignItems: 'center',
                                    gap: '4px',
                          ...
                          _jsxs(motion.div, {
                            ...
                            children: [
                              ...
                              _jsx('textarea', {
                                ...
                                onChange: (e) =>
                                  setDelegatePrompt(e.target.value),
                                ...
                                children: [
                                  ...
                                  _jsx('div', {
                                    ...
                                    children: peers
                                      ...
                                      .map((peer) => {
                                        const selected =
                                          delegateTargets.includes(peer.id);
                                        const colors =
                                          PROVIDER_COLORS[peer.provider] ??
                                          DEFAULT_COLORS;
                                        return _jsx(
                                          'button',
                                          {
                                ...
                                children: [
                                  ...
                                  delegateAttachments.length > 0 &&
                                    _jsx('div', {
                                      ...
                                      children: delegateAttachments.map(
                                        (att, attIdx) =>
                                          _jsxs(
                                            'div',
                                            {
                              ...
                              _jsx('button', {
                                ...
                                disabled:
                                  isDelegating || !delegatePrompt.trim(),
                                style: {
                                  width: '100%',
                                  marginTop: '12px',
                                  padding: '8px',
                                  background: isDelegating
                                    ? '#1e293b'
                                    : '#3b82f6',
                                  border: 'none',
                                  borderRadius: '8px',
                                ...
                                children: [
                                  ...
                                  selectedTask.attachments &&
                                    ...
                                    _jsx('div', {
                                      ...
                                      children: selectedTask.attachments.map(
                                        (att) =>
                                          _jsx(
                                            'div',
                                            {
                                    ...
                                    children: [
                                      ...
                                      result.attachments &&
                                        ...
                                        _jsx('div', {
                                          ...
                                          children: result.attachments.map(
                                            (att) =>
                                              _jsx(
                                                'div',
                                                {
