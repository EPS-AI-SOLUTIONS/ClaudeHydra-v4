  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('div', {
        ...
        children: _jsx(Icon, { size: 20, color: color }),
      }),
      _jsxs('div', {
        children: [
          _jsx('div', {
            style: { fontSize: '11px', color: '#8b8ba7', textTransform: 'uppercase', letterSpacing: '0.05em' },
            children: label,
          }),
          _jsx('div', { style: { fontSize: '20px', fontWeight: 700, color: '#e0e0ff' }, children: value }),
        ],
      }),
    ],
  });
...
function ActionBadge({ action }) {
  ...
  return _jsxs('span', {
    ...
    children: [_jsx(Icon, { size: 12 }), action],
  });
}
// ── Status Badge ─────────────────────────────────────────────────────────────
...
function CycleDetails({ cycleId }) {
  ...
  if (isLoading) {
    return _jsxs('div', {
      style: { padding: '12px', color: '#8b8ba7', display: 'flex', alignItems: 'center', gap: '8px' },
      children: [_jsx(Loader2, { size: 14, className: 'animate-spin' }), t('pruning.loadingDetails')],
    });
  }
      ...
      children: [
        _jsx('thead', {
          children: _jsxs('tr', {
            ...
            children: [
              _jsx('th', { style: { padding: '8px', textAlign: 'left' }, children: t('pruning.table.entity') }),
              _jsx('th', { style: { padding: '8px', textAlign: 'left' }, children: t('pruning.table.action') }),
              _jsx('th', { style: { padding: '8px', textAlign: 'left' }, children: t('pruning.table.reason') }),
              _jsx('th', { style: { padding: '8px', textAlign: 'right' }, children: t('pruning.table.similarity') }),
              _jsx('th', { style: { padding: '8px', textAlign: 'right' }, children: t('pruning.table.tokens') }),
            ],
          }),
        }),
        _jsx('tbody', {
          children: entries.map((entry) =>
            _jsxs(
              'tr',
              {
                ...
                children: [
                  _jsxs('td', {
                    style: { padding: '8px', color: '#e0e0ff', fontFamily: 'monospace', fontSize: '12px' },
                    children: [
                      entry.entity_name,
                      entry.merged_into &&
                        _jsxs('div', {
                  ...
                  _jsx('td', { style: { padding: '8px' }, children: _jsx(ActionBadge, { action: entry.action }) }),
                  _jsx('td', {
                    style: {
                      padding: '8px',
                      color: '#a0a0c0',
                  ...
                  _jsx('td', {
                    ...
                    children: entry.similarity_score != null ? `${(entry.similarity_score * 100).toFixed(1)}%` : '—',
                  }),
                  _jsx('td', {
                    style: { padding: '8px', textAlign: 'right', fontFamily: 'monospace', color: '#e0e0ff' },
                    children:
                        ...
                        ? _jsxs('span', {
                            children: [
                              ...
                              entry.tokens_before > entry.tokens_after &&
                                _jsxs('span', {
                                  style: { color: '#4ade80', marginLeft: '4px' },
                                  children: ['(-', entry.tokens_before - entry.tokens_after, ')'],
                                }),
                            ],
                          })
                        : '—',
      ...
      _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsx(Brain, { size: 24, color: '#c084fc' }),
              _jsxs('div', {
                children: [
                  _jsx('h2', {
          ...
          _jsxs('div', {
            ...
            children: [
              _jsxs('button', {
                ...
                children: [_jsx(Settings2, { size: 14 }), t('pruning.config')],
              }),
              _jsx('button', {
                type: 'button',
                ...
                children: isRunning
                  ...
                  : _jsxs(_Fragment, { children: [_jsx(Play, { size: 14 }), t('pruning.triggerPruning')] }),
              }),
            ],
          }),
        ],
        ...
        children:
          ...
          _jsx(motion.div, {
            ...
            children: _jsxs('div', {
              ...
              children: [
                _jsx('h3', {
                  style: { margin: '0 0 16px', fontSize: '15px', color: '#e0e0ff' },
                    ...
                    _jsxs('div', {
                      children: [
                        _jsxs('label', {
                          ...
                          style: { fontSize: '12px', color: '#8b8ba7', display: 'block', marginBottom: '4px' },
                          children: [t('pruning.minAge'), ': ', config.min_age_hours],
                        }),
                        _jsx('input', {
                          id: 'prune-min-age',
                          type: 'range',
                    ...
                    _jsxs('div', {
                      children: [
                        _jsxs('label', {
                          ...
                          style: { fontSize: '12px', color: '#8b8ba7', display: 'block', marginBottom: '4px' },
                          children: [t('pruning.maxEntries'), ': ', config.max_memory_entries],
                        }),
                        _jsx('input', {
                    ...
                    _jsxs('div', {
                      children: [
                        _jsxs('label', {
                          ...
                          style: { fontSize: '12px', color: '#8b8ba7', display: 'block', marginBottom: '4px' },
                          children: [t('pruning.autoInterval'), ': ', config.auto_prune_interval_secs],
                        }),
                        _jsx('input', {
                          id: 'prune-interval',
                          type: 'number',
                    ...
                    _jsxs('div', {
                      children: [
                        _jsxs('label', {
                          ...
                          style: { fontSize: '12px', color: '#8b8ba7', display: 'block', marginBottom: '4px' },
                          children: [t('pruning.maxCluster'), ': ', config.max_cluster_size],
                        }),
                        _jsx('input', {
        ...
        children: [
          ...
          statsLoading
            ? _jsxs('div', {
                ...
                children: [
                  _jsx(Loader2, { size: 24, className: 'animate-spin', style: { margin: '0 auto 8px' } }),
            ...
            : cycles.length === 0
              ? _jsxs('div', {
                  ...
                  children: [
                    _jsx(Brain, { size: 32, style: { margin: '0 auto 8px', opacity: 0.3 } }),
                    _jsx('div', { children: t('pruning.noCycles') }),
                    _jsx('div', { style: { fontSize: '12px', marginTop: '4px' }, children: t('pruning.noCyclesHint') }),
                  ],
                })
              : _jsx('div', {
                      ...
                      'div',
                      {
                        children: [
                          _jsxs('button', {
                            ...
                            children: [
                              isExpanded ? _jsx(ChevronDown, { size: 14 }) : _jsx(ChevronRight, { size: 14 }),
                              _jsx(StatusBadge, { status: cycle.status }),
                              _jsx('span', {
                                style: { fontFamily: 'monospace', fontSize: '11px', color: '#8b8ba7' },
                                children: new Date(cycle.started_at).toLocaleString('pl-PL'),
                              }),
                              _jsx('span', { style: { flex: 1 } }),
                              _jsxs('span', {
                                style: { display: 'flex', gap: '16px', fontSize: '12px', color: '#a0a0c0' },
                                children: [
                                  _jsxs('span', {
                                  ...
                                  _jsxs('span', {
                                    ...
                                    style: { color: '#4ade80' },
                                    children: [
                                      _jsx(Zap, { size: 12, style: { marginRight: '2px', verticalAlign: 'middle' } }),
                                  ...
                                  children: [
                                    cycle.error &&
                                      _jsxs('div', {
                                        ...
                                        children: [_jsx(XCircle, { size: 14 }), cycle.error],
                                      }),
