...
async function authenticateWithPasskey(email) {
  ...
  if (!startRes.ok) {
    ...
    throw new Error(body.error ?? 'Failed to start passkey login');
  }
          ...
          children: _jsxs('div', {
            ...
            children: [
              _jsxs('div', {
                ...
                children: [
                  _jsx('div', {
                    className: cn('shrink-0 p-2.5 rounded-xl', isLight ? 'bg-indigo-50' : 'bg-indigo-500/10'),
                    children: _jsx(Fingerprint, {
                      size: 20,
                      className: cn(isLight ? 'text-indigo-600' : 'text-indigo-400'),
                    }),
                  }),
                  _jsxs('div', {
                    ...
                    children: [
                      _jsx('h3', {
                        ...
                        children: t('passkey.title', 'Sign in with Passkey'),
                      }),
                      _jsx('p', {
                        className: cn('text-xs mt-0.5', theme.textMuted),
                        children: t(
                          'passkey.description',
                  ...
                  _jsx('button', {
                    ...
                    children: isLoading
                      ...
                      : _jsxs(_Fragment, {
                          children: [_jsx(ShieldCheck, { size: 16 }), t('passkey.signIn', 'Passkey')],
                        }),
                  }),
                ],
              }),
          ...
          children: _jsxs('div', {
            ...
            children: [
              ...
              _jsx('span', {
                ...
                children: t('passkey.success', 'Successfully authenticated with passkey'),
              }),
            ],
          }),
        }),
