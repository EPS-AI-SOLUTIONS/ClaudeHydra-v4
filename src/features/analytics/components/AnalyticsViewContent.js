...
function TokenUsageCard({ data, isLight }) {
  ...
  return _jsxs('div', {
    ...
    children: [
        ...
        return _jsxs(
          'div',
          {
            ...
            children: [
              _jsx('span', {
                className:
                  'font-mono text-xs text-[var(--matrix-text-secondary)] w-20 shrink-0',
                children: day.slice(5),
              }),
              _jsxs('div', {
                className:
                  'flex-1 flex h-5 rounded overflow-hidden bg-[var(--matrix-bg-secondary)]',
                children: [
                  _jsx('div', {
                    className: cn(
              ...
              _jsx('span', {
                className:
                  'font-mono text-xs text-[var(--matrix-text-secondary)] w-16 text-right shrink-0',
      ...
      _jsxs('div', {
        className:
          'flex items-center gap-4 pt-1 text-xs text-[var(--matrix-text-secondary)]',
        children: [
          _jsxs('span', {
        ...
        _jsx('thead', {
          children: _jsxs('tr', {
            ...
            children: [
              _jsx('th', {
                className:
                  'text-left py-2 px-2 font-medium text-[var(--matrix-text-secondary)]',
                children: t('analytics.tier', 'Tier'),
              }),
              _jsx('th', {
                className:
                  'text-right py-2 px-2 font-medium text-[var(--matrix-text-secondary)]',
                children: 'Avg',
              }),
              _jsx('th', {
                className:
              ...
              'tr',
              {
                ...
                children: [
                  ...
                  _jsx('td', {
                    ...
                    children: formatMs(row.avg),
                  }),
                  _jsx('td', {
                    className: 'text-right py-2 px-2 font-mono text-sm',
                    children: formatMs(row.p50),
                  }),
                  _jsx('td', {
                    className: 'text-right py-2 px-2 font-mono text-sm',
                    children: formatMs(row.p95),
                  }),
                  _jsx('td', {
                    className:
                      'text-right py-2 px-2 font-mono text-sm text-[var(--matrix-text-secondary)]',
                    children: row.count,
                  }),
                ],
              },
      ...
      return _jsxs(
        'div',
        {
          ...
          children: [
            ...
            _jsxs('span', {
              className:
                'text-xs text-[var(--matrix-text-secondary)] shrink-0 w-16 text-right',
      ...
      return _jsxs(
        'div',
        {
          ...
          children: [
            _jsxs('span', {
              className:
                'font-mono text-xs text-[var(--matrix-text-secondary)] w-5 shrink-0 text-right',
              children: [idx + 1, '.'],
            }),
            _jsxs('div', {
              ...
              children: [
                ...
                _jsx('div', {
                  className:
                    'h-1.5 rounded-full overflow-hidden bg-[var(--matrix-bg-secondary)]',
                  children: _jsx('div', {
                    className: cn(
            ...
            _jsx('span', {
              className:
                'font-mono text-xs text-[var(--matrix-text-secondary)] w-10 text-right shrink-0',
        ...
        children: [
          _jsxs('div', {
            children: [
              _jsxs('p', {
                className:
                  'text-xs text-[var(--matrix-text-secondary)] uppercase tracking-wider',
                children: [
                  t('analytics.periodCost', 'Period cost'),
                  ' (',
                  days,
                  'd)',
                ],
...
function EmptyState({ icon, message }) {
  return _jsxs('div', {
    ...
    children: [
      icon,
      _jsx('p', {
        className: 'text-sm text-[var(--matrix-text-secondary)]',
        children: message,
      }),
    ],
  });
    ...
    children: _jsxs('div', {
      ...
      children: [
        ...
        isLoading &&
          _jsx('p', {
            className:
              'text-sm text-[var(--matrix-text-secondary)] text-center py-6',
      ...
      children: [
        _jsxs('div', {
          ...
          children: [
            ...
            _jsx('div', {
              className: 'ml-auto',
              children: _jsx(TimeRangeSelector, {
                value: days,
                onChange: setDays,
                isLight: isLight,
              }),
        ...
        _jsxs('div', {
          ...
          children: [
            ...
            _jsx(SectionCard, {
              ...
              children: _jsx(TopToolsCard, {
                data: topTools.data?.data ?? [],
                isLight: isLight,
              }),
            }),
          ],
