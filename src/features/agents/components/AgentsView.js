    ...
    children: _jsx(Card, {
      ...
      children: _jsxs('div', {
        ...
        children: [
              ...
              _jsxs('div', {
                ...
                children: [
                  _jsxs('div', {
                    ...
                    children: [
                      _jsx('h3', {
                        className: 'text-sm font-semibold text-[var(--matrix-text-primary)] truncate',
                        children: agent.name,
                      }),
                      _jsx(StatusIndicator, { status: agent.status, size: 'sm' }),
                    ],
                  }),
                  _jsx('p', {
                    className: 'text-[11px] text-[var(--matrix-text-secondary)] truncate',
                    children: agent.role,
                  }),
                  _jsx('p', {
                    className: 'text-[10px] text-[var(--matrix-accent)]/60 font-mono truncate',
          ...
          _jsx('p', {
            className: 'text-xs text-[var(--matrix-text-secondary)] leading-relaxed line-clamp-2',
          ...
          _jsxs('div', {
            ...
            children: [
              _jsx(Badge, {
                ...
                size: 'sm',
                icon: _jsx(TierIcon, { size: 10 }),
                children: agent.tier,
              }),
              _jsx(StatusIndicator, { status: agent.status, size: 'sm', label: agent.status }),
            ],
          }),
        ],
      }),
    ...
    children: _jsxs('div', {
      ...
      children: [
            ...
            _jsxs(motion.div, {
              ...
              children: [
                _jsxs('div', {
                  ...
                  children: [
                    _jsx('div', {
                      ...
                      children: _jsx(Users, { size: 20, className: 'text-[var(--matrix-accent)]' }),
                    }),
                    _jsxs('div', {
                      children: [
                        _jsx('h2', {
                        ...
                        _jsxs('p', {
                          ...
                          children: [onlineCount, ' of ', CLAUDE_AGENTS.length, ' agents online'],
                        }),
                      ],
                    }),
                  ],
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsx(Filter, { size: 14, className: 'text-[var(--matrix-text-secondary)]' }),
                    TIER_FILTERS.map((tier) =>
                      _jsxs(
                        Button,
                        {
                          ...
                          children: [
                            tier,
                            _jsxs('span', { className: 'ml-1 opacity-70', children: ['(', tierCounts[tier], ')'] }),
                          ],
                        },
                        tier,
                      ),
                ...
                _jsx(AnimatePresence, {
                  ...
                  children: _jsx(
                    motion.div,
                    {
                      ...
                      children: filteredAgents.map((agent) => _jsx(AgentCard, { agent: agent }, agent.id)),
                    },
                    activeTier,
                  ),
                }),
        ...
        _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              className: 'flex items-center gap-2 p-3 border-b border-[var(--matrix-border)] bg-black/20',
              children: [
                _jsx(TerminalIcon, { size: 16, className: 'text-[var(--matrix-accent)]' }),
                _jsx('h3', {
                  className: 'text-sm font-mono font-semibold text-[var(--matrix-text-primary)]',
                  children: 'Agents Terminal',
                }),
                isLoading &&
                  _jsx('span', {
                    className: 'ml-auto text-xs text-[var(--matrix-text-secondary)] animate-pulse',
                    children: 'Loading...',
                  }),
              ],
            }),
            _jsxs('div', {
              className: 'flex-1 overflow-y-auto p-3 space-y-1.5 font-mono text-[10px] sm:text-xs bg-black/40',
              children: [
                logs.length === 0 &&
                  !isLoading &&
                  _jsx('div', {
                ...
                logs.map((entry, i) =>
                  _jsxs(
                    'div',
                    {
                      ...
                      children: [
                        _jsx('span', {
                          className: 'text-[var(--matrix-text-secondary)] opacity-50 shrink-0',
                          children: formatTimestamp(entry.timestamp),
                        }),
                        _jsxs('span', {
                          className: cn('shrink-0 font-semibold', levelBadgeClasses(entry.level)),
                        ...
                        _jsxs('span', {
                          ...
                          children: [
                            _jsxs('span', {
                              className: 'text-[var(--matrix-accent)] opacity-70 mr-1',
