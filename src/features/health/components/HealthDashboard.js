...
const StatCard = memo(({ icon, label, value, statusColor }) => {
  ...
  return _jsxs(Card, {
    ...
    children: [
      _jsx('div', { className: cn('shrink-0', theme.iconMuted), children: icon }),
      _jsxs('div', {
        className: 'flex-1 min-w-0',
        children: [
          _jsx('p', {
            className: cn('text-[10px] uppercase tracking-wider font-mono', theme.textMuted),
            children: label,
          }),
          _jsx('p', {
            className: cn('text-sm font-mono font-semibold truncate', statusColor ?? theme.text),
            children: value,
          }),
        ],
      }),
...
export const HealthDashboard = memo(() => {
  ...
  if (data.loading) {
    return _jsxs('div', {
      ...
      children: [
        _jsx('h3', {
          className: cn('text-sm font-mono font-semibold uppercase tracking-wider mb-3', theme.textMuted),
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx('h3', {
            className: cn('text-sm font-mono font-semibold uppercase tracking-wider', theme.textMuted),
            children: t('health.title', 'System Health'),
          }),
          _jsx('button', {
            type: 'button',
            ...
            children: _jsx(RefreshCw, { size: 14, className: isRefreshing ? 'animate-spin' : '' }),
          }),
        ],
      }),
