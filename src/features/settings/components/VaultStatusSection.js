  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsx(Mountain, { size: 18, className: 'text-[var(--matrix-accent)]' }),
              _jsxs('div', {
                children: [
                  _jsx('h3', {
          ...
          _jsxs('div', {
            className: 'flex items-center gap-2',
            children: [
              _jsx('span', { className: cn('w-2.5 h-2.5 rounded-full', statusCfg.color, statusCfg.pulseClass) }),
              _jsx('span', { className: cn('text-xs font-mono font-semibold', theme.text), children: statusCfg.label }),
            ],
          }),
        ],
      }),
      ...
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx(StatCard, {
            ...
            icon: _jsx(RefreshCw, { size: 14 }),
          }),
          _jsx(StatCard, {
            theme: theme,
            label: 'ACL',
            value: vaultHealth?.acl_enabled ? 'ON' : 'OFF',
            icon: _jsx(ShieldAlert, { size: 14 }),
            badge: true,
          }),
        ],
      }),
      _jsxs('div', {
        children: [
          _jsxs('button', {
            ...
            children: [
              namespacesOpen ? _jsx(ChevronDown, { size: 14 }) : _jsx(ChevronRight, { size: 14 }),
                  ...
                  children: _jsx('div', {
                    ...
                    children:
                      namespaces && namespaces.length > 0
                        ? namespaces.map((ns) => _jsx(NamespaceRow, { ns: ns, theme: theme }, ns.name))
                        : _jsx('p', {
                            className: cn('text-xs font-mono', theme.textMuted),
                            children: t('settings.vault.noNamespaces', 'No namespaces available'),
                          }),
                  }),
                },
                'ns-list',
      ...
      _jsxs('div', {
        ...
        children: [
          _jsx('h4', {
            className: cn('text-xs font-mono font-semibold uppercase tracking-wider', theme.text),
          ...
          auditEntries && auditEntries.length > 0
            ? _jsx('div', {
                ...
                children: auditEntries.map((entry) =>
                  _jsx(AuditRow, { entry: entry, theme: theme }, `${entry.timestamp}-${entry.action}-${entry.service}`),
                ),
              })
            : _jsx('p', {
                className: cn('text-xs font-mono', theme.textMuted),
                children: t('settings.vault.noAudit', 'No recent audit entries'),
              }),
        ],
      }),
      _jsxs('div', {
        className: cn('border rounded-lg', emergencyOpen ? 'border-red-500/50' : 'border-red-500/20'),
        children: [
          _jsxs('button', {
            type: 'button',
            ...
            children: [
              _jsx(ShieldAlert, { size: 14 }),
              emergencyOpen ? _jsx(ChevronDown, { size: 12 }) : _jsx(ChevronRight, { size: 12 }),
                      ...
                      _jsxs('div', {
                        ...
                        children: [
                          _jsxs('div', {
                            className: 'flex items-center gap-2',
                            children: [
                              _jsx(Trash2, { size: 14, className: 'text-red-400' }),
                              _jsx('span', {
                          ...
                          _jsx('p', {
                            className: cn('text-[10px] font-mono', theme.textMuted),
                            children: t('settings.vault.panicDesc', 'Destroys all credentials. Type PANIC to confirm.'),
                          }),
                          _jsxs('div', {
                            className: 'flex items-center gap-2',
                            children: [
                              ...
                              _jsx(Button, {
                                variant: 'danger',
                                size: 'sm',
                                leftIcon: _jsx(Trash2, { size: 12 }),
                                onClick: handlePanic,
                                disabled: panicInput !== 'PANIC' || panicLoading,
                                isLoading: panicLoading,
                                children: t('settings.vault.panicButton', 'Destroy Vault'),
                              }),
                            ],
                          }),
                        ],
                      ...
                      _jsxs('div', {
                        ...
                        children: [
                          _jsxs('div', {
                            className: 'flex items-center gap-2',
                            children: [
                              _jsx(RefreshCw, { size: 14, className: 'text-amber-400' }),
                              _jsx('span', {
                                className: cn('text-xs font-mono font-semibold', theme.text),
                                children: t('settings.vault.rotateTitle', 'Rotate All Credentials'),
                              }),
                            ],
                          }),
                          _jsx('p', {
                            className: cn('text-[10px] font-mono', theme.textMuted),
                            children: t('settings.vault.rotateDesc', 'Triggers credential rotation for all providers.'),
                          }),
                          _jsx(Button, {
                            variant: 'ghost',
                            size: 'sm',
                            leftIcon: _jsx(RefreshCw, { size: 12 }),
                            onClick: handleRotate,
                            isLoading: rotateLoading,
                            children: t('settings.vault.rotateButton', 'Rotate All'),
                          }),
                        ],
                      }),
                    ],
...
const StatCard = memo(({ theme, label, value, icon, small, badge }) =>
  _jsxs('div', {
    className: cn('rounded-lg p-2.5 bg-[var(--matrix-glass)] border border-white/5'),
    children: [
      _jsxs('div', {
        className: 'flex items-center gap-1.5 mb-1',
        children: [
          _jsx('span', { className: 'text-[var(--matrix-accent)]', children: icon }),
          _jsx('span', {
            className: cn('text-[10px] font-mono uppercase tracking-wider', theme.textMuted),
            children: label,
          }),
        ],
      }),
      badge
        ...
        : _jsx('span', {
            className: cn('font-mono font-bold', small ? 'text-xs' : 'text-lg', theme.text),
            children: value,
          }),
    ],
  }),
...
const NamespaceRow = memo(({ ns, theme }) =>
  _jsxs('div', {
    className: 'space-y-1',
    children: [
      _jsx('span', { className: cn('text-xs font-mono font-semibold', theme.text), children: ns.name }),
      _jsx('div', {
        ...
        children: ns.services.map((svc) =>
          _jsxs(
            'div',
            {
              ...
              children: [
                _jsx('span', {
                  className: cn('w-1.5 h-1.5 rounded-full', svc.connected ? 'bg-emerald-500' : 'bg-red-500/60'),
                }),
                _jsx('span', { className: cn('text-[10px] font-mono', theme.textMuted), children: svc.name }),
              ],
            },
            svc.name,
          ),
...
const AuditRow = memo(({ entry, theme }) =>
  _jsxs('div', {
    ...
    children: [
      _jsx('span', { className: cn('min-w-[100px]', theme.textMuted), children: formatTimestamp(entry.timestamp) }),
      _jsx(Badge, { variant: entry.action === 'DELEGATE' ? 'accent' : 'default', size: 'sm', children: entry.action }),
      entry.agent &&
        entry.agent !== 'unknown' &&
        _jsx('span', { className: 'text-[9px] text-blue-400/80', children: entry.agent }),
      _jsxs('span', { className: cn('flex-1 truncate', theme.text), children: [entry.namespace, '/', entry.service] }),
      _jsx('span', {
        className: cn(
