        ...
        children: _jsxs('div', {
          ...
          children: [
            ...
            _jsxs('div', {
              ...
              children: [
                _jsx('div', {
                  className: 'shrink-0 p-2.5 rounded-xl bg-[var(--matrix-accent)]/10',
                  children: _jsx(Crown, { size: 20, className: 'text-[var(--matrix-accent)]' }),
                }),
                _jsxs('div', {
                  ...
                  children: [
                    ...
                    _jsx('p', { className: cn('text-xs mt-1', theme.textMuted), children: t('oauth.bannerDesc') }),
                    _jsxs('div', {
                      ...
                      children: [
                        _jsx(Button, {
                          variant: 'primary',
                          size: 'sm',
                          rightIcon: _jsx(ArrowRight, { size: 13 }),
