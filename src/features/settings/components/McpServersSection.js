  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsxs('div', {
        ...
        children: [
          _jsx(Button, { variant: 'ghost', size: 'sm', onClick: onClose, children: t('common.cancel', 'Cancel') }),
          _jsx(Button, {
            size: 'sm',
            onClick: handleSubmit,
            disabled: !name.trim() || !url.trim() || createMutation.isPending,
            children: createMutation.isPending ? t('common.loading', 'Loading...') : t('mcp.addServer', 'Add Server'),
          }),
        ],
      }),
    ],
    ...
    children: toolsList.map((tool) =>
      _jsxs(
        'div',
        {
          ...
          children: [
            _jsx(Wrench, { size: 12, className: 'text-[var(--matrix-accent)] mt-0.5 shrink-0' }),
            _jsxs('div', {
              children: [
                _jsx('span', { className: cn('text-xs font-mono font-medium', theme.text), children: tool.tool_name }),
                tool.description &&
                  _jsx('p', { className: cn('text-[10px] font-mono', theme.textMuted), children: tool.description }),
              ],
            }),
          ],
        },
      ...
      _jsxs('div', {
        ...
        children: [
          _jsx('button', {
            ...
            children: expanded
              ? _jsx(ChevronDown, { size: 14, className: theme.textMuted })
              : _jsx(ChevronRight, { size: 14, className: theme.textMuted }),
          }),
          _jsx('div', {
            className: cn('w-2 h-2 rounded-full shrink-0', isConnected ? 'bg-emerald-400' : 'bg-zinc-500'),
          }),
          _jsx('span', { className: cn('text-sm font-mono font-medium flex-1', theme.text), children: server.name }),
          _jsx('span', {
          ...
          _jsx(Button, {
            ...
            children: isConnected ? _jsx(PowerOff, { size: 14 }) : _jsx(Power, { size: 14 }),
          }),
          _jsx(Button, {
            variant: 'ghost',
            size: 'sm',
            ...
            disabled: busy,
            'aria-label': 'Delete',
            children: _jsx(Trash2, { size: 14, className: 'text-red-400' }),
          }),
        ],
      }),
...
export const McpServersSection = memo(() => {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            className: 'flex items-center gap-2',
            children: [
              _jsx(Network, { size: 18, className: 'text-[var(--matrix-accent)]' }),
              _jsx('h3', {
          ...
          _jsxs(Button, {
            ...
            children: [
              _jsx(Plus, { size: 14 }),
              _jsx('span', { className: 'ml-1 text-xs', children: t('mcp.addServer', 'Add Server') }),
            ],
          }),
        ],
      }),
      ...
      showAddForm && _jsx(AddServerForm, { onClose: () => setShowAddForm(false) }),
      isLoading &&
        _jsx('p', { className: cn('text-xs font-mono', theme.textMuted), children: t('common.loading', 'Loading...') }),
      !isLoading &&
        !servers.length &&
        !showAddForm &&
        _jsx('p', {
      ...
      _jsx('div', {
        className: 'space-y-2',
        children: servers.map((server) => _jsx(ServerRow, { server: server }, server.id)),
      }),
    ],
  });
});
