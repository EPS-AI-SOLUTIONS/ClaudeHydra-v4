  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx('h3', { className: 'text-lg font-semibold', children: 'WASM Edge Computing' }),
          _jsxs('span', {
            ...
            children: [
              _jsx('span', {
                className: `h-1.5 w-1.5 rounded-full ${isReady ? 'bg-emerald-400' : error ? 'bg-red-400' : 'bg-yellow-400 animate-pulse'}`,
              }),
        ...
        children: tabs.map((tab) =>
          _jsx(
            'button',
            {
              ...
              className: `flex-1 rounded-md px-3 py-1.5 text-sm font-medium transition-colors ${activeTab === tab.id ? 'bg-neutral-700 text-neutral-100' : 'text-neutral-400 hover:text-neutral-200'}`,
              children: tab.label,
            },
            tab.id,
          ),
            ...
            tokenCount !== null &&
              _jsx('div', {
                ...
                children: _jsxs('span', {
                  ...
                  children: [
                    'Estimated tokens: ',
                    _jsx('span', { className: 'font-mono font-bold', children: tokenCount }),
                  ],
                }),
              }),
            benchResult &&
              _jsx('div', {
                ...
                children: _jsx('span', { className: 'text-sm text-amber-300 font-mono', children: benchResult }),
              }),
            cacheInfo &&
              _jsx('div', {
                className: 'rounded-lg border border-neutral-600 bg-neutral-800 p-3',
                children: _jsxs('span', {
                  className: 'text-sm text-neutral-300',
                  children: ['WASM Cache: ', _jsx('span', { className: 'font-mono', children: cacheInfo })],
                }),
              }),
            maskResult &&
              _jsxs('div', {
        ...
        _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              className: 'space-y-2',
              children: [
                _jsx('label', { htmlFor: 'sim-text-a', className: 'text-sm text-neutral-400', children: 'Text A' }),
                _jsx('input', {
                  id: 'sim-text-a',
                  value: simTextA,
                ...
                _jsx('label', { htmlFor: 'sim-text-b', className: 'text-sm text-neutral-400', children: 'Text B' }),
                _jsx('input', {
                  id: 'sim-text-b',
                  value: simTextB,
            ...
            simResult &&
              _jsxs('div', {
                ...
                children: [
                  _jsx(ScoreCard, { label: 'Cosine (trigram)', value: simResult.cosine, color: 'teal' }),
                  _jsx(ScoreCard, { label: 'Levenshtein', value: simResult.levenshtein, color: 'blue' }),
                  _jsx(ScoreCard, { label: 'Jaccard (words)', value: simResult.jaccard, color: 'purple' }),
                ],
              }),
            simBenchResult &&
              _jsx('div', {
                className: 'rounded-lg border border-amber-500/30 bg-amber-500/10 p-3',
                children: _jsx('span', { className: 'text-sm text-amber-300 font-mono', children: simBenchResult }),
              }),
            _jsxs('div', {
              ...
              children: [
                ...
                _jsx('label', { htmlFor: 'batch-query', className: 'text-sm text-neutral-400', children: 'Query' }),
                _jsx('input', {
                  id: 'batch-query',
                  value: batchQuery,
                    ...
                    children: batchResults.map((r) => {
                      ...
                      return _jsxs(
                        'div',
                        {
                          ...
                          children: [
                            _jsx('div', {
                              className: 'flex-1 text-sm text-neutral-200 font-mono truncate',
                              children: candidateLines[r.index],
                            }),
                            _jsxs('div', {
                              className: 'flex gap-2 text-xs font-mono shrink-0',
                              children: [
                                _jsxs('span', {
                                  className: 'text-teal-400',
                                  children: [(r.combined * 100).toFixed(1), '%'],
                                }),
                                _jsxs('span', {
      ...
      activeTab === 'analysis' &&
        _jsxs('div', {
          ...
          children: [
            ...
            textStats &&
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsx(StatCard, { label: 'Sentences', value: textStats.sentences }),
                  _jsx(StatCard, { label: 'Unique words', value: textStats.unique_words }),
                  _jsx(StatCard, { label: 'Characters', value: textStats.chars }),
                  _jsx(StatCard, { label: 'Avg word length', value: textStats.avg_word_length.toFixed(1) }),
                  _jsx(StatCard, {
                    label: 'Reading time',
                    value:
            ...
            textHash &&
              _jsxs('div', {
                className: 'rounded-lg border border-neutral-600 bg-neutral-800 p-2.5',
                children: [
                  _jsx('span', { className: 'text-xs text-neutral-400', children: 'FNV-1a hash: ' }),
                  _jsx('span', { className: 'text-xs text-neutral-200 font-mono', children: textHash }),
                ],
              }),
            keywords &&
              keywords.length > 0 &&
              _jsxs('div', {
                className: 'space-y-1',
                children: [
                  _jsx('span', { className: 'text-sm text-neutral-400', children: 'Keywords' }),
                  _jsx('div', {
            ...
            wordFreqs &&
              ...
              _jsxs('div', {
                className: 'space-y-1',
                children: [
                  _jsx('span', { className: 'text-sm text-neutral-400', children: 'Word Frequency (top 10)' }),
                  _jsx('div', {
                    className: 'space-y-1',
                    children: wordFreqs.map((wf) =>
                      _jsxs(
                        'div',
                        {
                          ...
                          children: [
                            _jsx('span', {
                              className: 'text-xs text-neutral-200 font-mono w-24 truncate',
                              children: wf.word,
                            }),
                            _jsx('div', {
                              className: 'flex-1 h-3 rounded-full bg-neutral-800 overflow-hidden',
                              children: _jsx('div', {
                            ...
                            _jsxs('span', {
                              className: 'text-xs text-neutral-500 font-mono w-16 text-right',
      ...
      _jsxs('div', {
        className: 'rounded-lg border border-neutral-700 bg-neutral-800/50 p-3 space-y-1',
        children: [
          _jsx('p', {
...
function ScoreCard({ label, value, color }) {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', { className: 'text-xl font-bold font-mono', children: [pct, '%'] }),
...
function StatCard({ label, value }) {
  return _jsxs('div', {
    ...
    children: [
      _jsx('div', { className: 'text-lg font-bold font-mono text-neutral-200', children: value }),
      _jsx('div', { className: 'text-xs text-neutral-500 mt-0.5', children: label }),
    ],
  });
}
