  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          enabled
            ? _jsx(Bell, { size: 18, className: 'text-[var(--matrix-accent)]' })
            : _jsx(BellOff, { size: 18, className: 'text-[var(--matrix-accent)]' }),
          _jsx('h3', {
      ...
      _jsxs('div', {
        ...
        children: [
          ...
          enabled &&
            _jsxs('span', {
              className: cn('text-xs font-mono min-w-[3ch] text-right', theme.textMuted),
