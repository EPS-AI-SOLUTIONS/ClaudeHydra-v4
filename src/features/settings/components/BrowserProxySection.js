  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx(Globe, { size: 18, className: 'text-[var(--matrix-accent)]' }),
          _jsx('h3', {
      ...
      _jsx('p', { className: cn('text-xs', theme.textMuted), children: t('settings.browserProxy.description') }),
      isLoading
        ? _jsxs('div', {
            className: 'flex items-center gap-2',
            children: [
              _jsx(Loader2, { size: 14, className: 'animate-spin text-[var(--matrix-accent)]' }),
              _jsx('span', {
                        ...
                        children: t('settings.browserProxy.notConfiguredHint')
                          ...
                          .map((part, i) => {
                            ...
                            return _jsxs(
                              ...
                              {
                                children: [
                                  _jsx('code', { className: 'text-[var(--matrix-accent)]', children: code }),
                                  rest,
                                ],
                              },
                              code,
                ...
                _jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      _jsx('p', {
                        className: cn('text-xs', theme.textMuted),
                        children: t('settings.browserProxy.unreachableHint', { url: status?.proxy_url })
                          .split('<code>')
                          .map((part, i) => {
                            if (i === 0) return part;
                            const [code, rest] = part.split('</code>');
                    ...
                    children: [
                      ...
                      status?.login?.last_login_error &&
                        _jsxs('div', {
                          ...
                          children: [
                            _jsx(AlertTriangle, { size: 14 }),
                            _jsx('span', { className: 'text-xs', children: status.login.last_login_error }),
                          ],
                        }),
                    ],
                  },
                ...
                _jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      status?.login?.last_login_error &&
                        _jsxs('div', {
                          className: 'flex items-center gap-2 text-red-400 mt-1',
                          children: [
                            _jsx(AlertTriangle, { size: 14 }),
                            _jsx('span', { className: 'text-xs', children: status.login.last_login_error }),
                          ],
                      ...
                      _jsxs('div', {
                        ...
                        children: [
                          _jsx(Badge, {
                            variant: 'accent',
                            size: 'sm',
                            icon: _jsx(CheckCircle, { size: 12 }),
                            children: ready ? t('settings.browserProxy.ready') : t('settings.browserProxy.loggedIn'),
                          }),
                          _jsx('span', {
                            className: cn('text-xs font-mono', theme.textMuted),
                            children: t('settings.browserProxy.workers', { ready: workersReady, total: poolSize }),
                          }),
                        ],
                      }),
                      _jsxs('div', {
                        ...
                        _jsxs('div', {
                          ...
                          children: [
                            ...
                            _jsx('span', {
                              ...
                              children: t('settings.browserProxy.errors', { count: status?.health?.total_errors }),
                            }),
                          ],
                        }),
                      _jsxs('div', {
                        ...
                        children: [
                          _jsx(Button, {
                            variant: 'ghost',
                            size: 'sm',
                            leftIcon: _jsx(RefreshCw, { size: 14 }),
...
const StatItem = memo(({ label, value, theme }) =>
  _jsxs('div', {
    ...
    children: [
      _jsx('div', { className: cn('text-[10px] font-mono', theme.textMuted), children: label }),
      _jsx('div', { className: 'text-xs font-mono font-medium text-[var(--matrix-accent)]', children: value }),
    ],
  }),
);
