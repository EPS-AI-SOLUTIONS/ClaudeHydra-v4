...
export const AutoUpdaterSection = memo(() => {
  ...
  const toggle = useCallback(async () => {
    setSaving(true);
    try {
      await apiPost('/api/settings', { ...settings, auto_updater: !enabled });
      await refetch();
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx(RefreshCw, { size: 18, className: 'text-[var(--matrix-accent)]' }),
          _jsx('h3', {
      ...
      _jsx('p', {
        ...
        children: t('settings.autoUpdater.description', 'Automatically check for and apply updates when available.'),
      }),
      _jsxs('div', {
