  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx(Activity, { size: 18, className: 'text-[var(--matrix-accent)]' }),
          _jsx('h3', {
      ...
      _jsx('p', { className: cn('text-xs', theme.textMuted), children: t('settings.watchdog.description') }),
      isLoading
        ? _jsx('div', { className: cn('text-xs font-mono', theme.textMuted), children: t('common.loading') })
        : events.length === 0
          ? _jsx('div', {
              ...
              children: events.map((evt) => {
                ...
                return _jsxs(
                  'div',
                  {
                    ...
                    children: [
                      _jsx(Icon, { size: 13, className: cn('shrink-0', cfg.color) }),
                      _jsx('span', {
                      ...
                      _jsx('span', { className: cn('font-medium', cfg.color), children: cfg.label }),
                      _jsx('span', { className: cn('shrink-0', theme.textMuted), children: workerInfo }),
                      evt.error &&
                        _jsx('span', {
