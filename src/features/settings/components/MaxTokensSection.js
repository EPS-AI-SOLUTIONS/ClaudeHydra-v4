...
export const MaxTokensSection = memo(() => {
  ...
  const save = useCallback(
    async (value) => {
      ...
      setSaving(true);
      try {
        await apiPost('/api/settings', { ...settings, max_tokens: clamped });
        await refetch();
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx(TextCursorInput, { size: 18, className: 'text-[var(--matrix-accent)]' }),
          _jsx('h3', {
      ...
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx('span', {
            className: cn('text-lg font-mono font-bold min-w-[4ch] text-center', theme.text),
