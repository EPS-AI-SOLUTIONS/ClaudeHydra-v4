  ...
  return _jsxs(motion.div, {
    ...
    children: [
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              ...
              _jsx('h1', { className: 'text-lg font-semibold text-zinc-100', children: t('collab.title') }),
              _jsx('span', {
          ...
          _jsxs('div', {
            className: 'flex items-center gap-3',
            children: [
              _jsx(CollabStatusBadge, { status: status, peerCount: peers.length }),
              status === 'connected'
                ? _jsxs('button', {
                    type: 'button',
                    onClick: disconnect,
                    ...
                    children: [_jsx(PlugZap, { className: 'h-3.5 w-3.5' }), t('collab.disconnect')],
                  })
                : _jsxs('button', {
                    type: 'button',
                    onClick: connect,
                    ...
                    children: [_jsx(Plug, { className: 'h-3.5 w-3.5' }), t('collab.connect')],
                  }),
            ],
          }),
        ],
      ...
      _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            className: 'flex flex-1 flex-col rounded-lg border border-zinc-700/50 bg-zinc-900/50',
            children: [
              _jsxs('div', {
                className: 'flex items-center gap-2 border-b border-zinc-700/50 px-3 py-2',
                children: [
                  _jsx('button', {
                    type: 'button',
                    onClick: undo,
          ...
          _jsxs('div', {
            className: 'w-64 shrink-0 rounded-lg border border-zinc-700/50 bg-zinc-900/50 p-4',
            children: [
              _jsxs('div', {
                className: 'flex items-center gap-2 mb-4',
                children: [
                  _jsx(Activity, { className: 'h-4 w-4 text-zinc-400' }),
                  _jsx('h2', { className: 'text-sm font-medium text-zinc-300', children: t('collab.roomStats') }),
                ],
              }),
              stats
                ? _jsxs('div', {
                    ...
                    children: [
                      _jsxs('div', {
                        ...
                        children: [
                          ...
                          _jsx('span', { className: 'text-zinc-200', children: stats.active_rooms }),
                        ],
                      }),
                      _jsxs('div', {
                        className: 'flex justify-between text-zinc-400',
                        children: [
                          ...
                          _jsx('span', { className: 'text-zinc-200', children: stats.total_peers }),
                        ],
                      }),
                      _jsxs('div', {
                        className: 'flex justify-between text-zinc-400',
                        children: [
                          ...
                          _jsx('span', { className: 'text-zinc-200', children: stats.total_documents }),
                        ],
                      }),
                      stats.rooms.length > 0 &&
                        _jsxs('div', {
                          ...
                          children: [
                            _jsx('h3', { className: 'text-zinc-500 font-medium', children: t('collab.rooms') }),
                            stats.rooms.map((room) =>
                              _jsxs(
                                'div',
                                {
                                  ...
                                  children: [
                                    _jsx('div', {
                                      className: 'truncate text-zinc-300 font-mono',
                                      children: room.room_key,
                                    }),
                                    _jsxs('div', {
                                      className: 'mt-1 flex gap-3 text-zinc-500',
                                      children: [
                                        _jsxs('span', { children: [room.peer_count, ' peers'] }),
                                        _jsxs('span', { children: ['v', room.version] }),
                                        _jsxs('span', {
                                          children: [(room.document_size_bytes / 1024).toFixed(1), 'KB'],
                                        }),
                                      ],
                                    }),
                                  ],
                ...
                : _jsx('p', { className: 'text-xs text-zinc-600', children: t('collab.loadingStats') }),
            ],
          }),
        ],
      }),
