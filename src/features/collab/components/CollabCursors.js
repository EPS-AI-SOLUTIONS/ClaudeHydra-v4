    ...
    children: peers.map((peer) =>
      _jsxs(
        'div',
        {
          ...
          children: [
            _jsx('div', { className: 'h-2 w-2 rounded-full', style: { backgroundColor: peer.userColor } }),
            _jsx('span', { className: 'opacity-80', children: peer.userName }),
            peer.isAgent &&
              _jsx('span', { className: 'rounded bg-blue-500/20 px-1 text-blue-400 text-[10px]', children: 'AI' }),
          ],
        },
        peer.clientId,
      ),
