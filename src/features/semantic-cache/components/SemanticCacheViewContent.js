    ...
    children: _jsxs('div', {
      ...
      children: [
        _jsx('div', {
          ...
          children: _jsx(Icon, { width: 18, height: 18 }),
        }),
        _jsxs('div', {
  ...
  return _jsxs('div', {
    ...
    children: [
      ok
        ...
        : _jsx(XCircle, { width: 14, height: 14, className: 'text-red-400' }),
      _jsx('span', {
  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsx('button', {
        ...
        title: 'Delete entry',
        children: _jsx(Trash2, { width: 14, height: 14 }),
      }),
    ],
  });
}
    ...
    children: _jsxs('div', {
      ...
      children: [
            ...
            _jsxs('div', {
              children: [
                ...
                _jsx('p', {
                  ...
                  children:
                    'Qdrant Vector Router \u2022 AST Context Compression \u2022 Few-Shot Fallback',
                }),
              ],
            }),
            _jsxs('div', {
                ...
                _jsxs('button', {
                  ...
                  children: [
                    _jsx(RefreshCw, {
                      width: 14,
                      height: 14,
                      className: invalidateCache.isPending
                        ? 'animate-spin'
                        : '',
                    }),
                    'Flush Cache',
          ...
          _jsx('div', {
            ...
            children: _jsxs('div', {
              ...
              children: [
                _jsx('div', {
                  className:
                    'w-5 h-5 border-2 border-emerald-400 border-t-transparent rounded-full animate-spin',
                }),
                _jsx('span', {
                  className: cn(
                    'text-sm',
        ...
        health &&
          ...
          _jsxs('div', {
            className:
              'flex items-center gap-3 px-4 py-3 rounded-xl bg-amber-500/10 border border-amber-500/20',
            children: [
              _jsx(AlertTriangle, {
                width: 16,
                height: 16,
