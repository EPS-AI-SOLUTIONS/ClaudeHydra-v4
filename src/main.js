    ...
    switch (currentView) {
      ...
      case 'agents':
        return _jsx(ErrorBoundary, {
          fallback: _jsx(FeatureErrorFallback, {
            feature: 'Agents',
...
function JaskierAuthGate({ children }) {
  ...
  if (!user) {
    return _jsxs('div', {
      className:
        'flex flex-col items-center justify-center h-screen gap-6 font-mono',
      children: [
        _jsx('h1', {
          className: 'text-2xl font-bold',
          children: 'ClaudeHydra',
        }),
        _jsx('p', {
  ...
  return _jsx(ApprovalGate, { appName: 'Claude Hydra', children: children });
}
function App() {
      ...
      children: [
        _jsx(JaskierAuthGate, {
          children: _jsx(QueryErrorResetBoundary, {
            children: () =>
              _jsx(ErrorBoundary, {
                children: _jsx(AppShell, { children: _jsx(ViewRouter, {}) }),
              }),
          }),
        }),
        _jsx(OfflineBanner, {}),
        ...
        _jsx(Suspense, {
          fallback: null,
          children: _jsx(ReactQueryDevtools, { initialIsOpen: false }),
        }),
      ],
    }),
  });
