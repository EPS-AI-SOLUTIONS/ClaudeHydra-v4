  ...
  ({
    ...
    return _jsxs(motion.div, {
      ...
      onDragStart: (e) => {
        ...
        e.dataTransfer?.setData('text/plain', String(tabIndex_));
      ...
      children: [
        tab.isPinned &&
          _jsx(Pin, { size: 13, className: cn('shrink-0', theme.isLight ? 'text-emerald-600' : 'text-white/70') }),
        !tab.isPinned && _jsx('span', { className: 'flex-1 truncate', children: tab.title || 'New Chat' }),
        messageCount > 0 &&
          !tab.isPinned &&
          _jsx('span', {
            className: cn(
...
export const TabBar = memo(() => {
  ...
  const handleContextMenuOpen = useCallback((x, y, tabId) => {
  ...
  const getMessageCount = useCallback(
    (sessionId) => sessions.find((s) => s.id === sessionId)?.messageCount ?? 0,
    [sessions],
  );
  const handleArrowNav = useCallback(
    (tabId, direction) => {
      ...
      requestAnimationFrame(() => {
        const el = scrollRef.current?.querySelector(`[data-tab-id="${nextTab.id}"]`);
        el?.focus();
      });
    },
    [tabs, switchTab],
  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsx('button', {
        ...
        children: _jsx(Plus, { size: 18, strokeWidth: 2.5 }),
      }),
                  ...
                  children: [
                    ...
                    !targetTab.isPinned &&
                      _jsxs('button', {
                        ...
                        children: [_jsx(X, { size: 14 }), t('tabs.closeTab', 'Close tab')],
                      }),
                      ...
                      _jsxs(_Fragment, {
                        children: [
                          _jsx('div', {
                            className: cn(
                              'mx-2 my-1 border-t',
                              theme.isLight ? 'border-slate-200/50' : 'border-white/10',
                            ),
                          }),
                          _jsxs('button', {
                            type: 'button',
                            ...
                            children: [_jsx(X, { size: 14 }), t('tabs.closeOtherTabs', 'Close other tabs')],
                          }),
                        ],
                      }),
                  ],
