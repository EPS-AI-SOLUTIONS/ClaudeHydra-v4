  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('div', {
        ...
        onWheel: handleWheel,
        className:
          'flex items-end gap-1 overflow-x-auto scrollbar-hide flex-1 min-w-0',
      ...
      _jsx('button', {
        ...
        children: _jsx(Plus, { width: 18, height: 18, strokeWidth: 2.5 }),
      }),
                  ...
                  children: [
                    ...
                    !targetTab.isPinned &&
                      _jsxs('button', {
                        ...
                        children: [
                          _jsx(X, { width: 14, height: 14 }),
                          t('tabs.closeTab', 'Close tab'),
                        ],
                      }),
                    tabs.filter(
                      (t) => t.id !== contextMenu.tabId && !t.isPinned,
                    ).length > 0 &&
                      _jsxs(_Fragment, {
                        children: [
                          _jsx('div', {
