                  ...
                  _jsxs('button', {
                    ...
                    children: [
                      _jsxs('div', {
                        ...
                        children: [
                          _jsx(GroupIcon, { width: 14, height: 14 }),
                          _jsx('span', {
                            className:
                      ...
                      'button',
                      {
                        ...
                        children: [
                          ...
                          !collapsed &&
                            _jsx('span', {
                              className:
                                'font-medium text-base tracking-wide truncate',
                              children: item.label,
                            }),
                          isActive &&
                            _jsx('div', {
          ...
          _jsxs('div', {
            ...
            children: [
              _jsxs('button', {
                ...
                children: [
                  _jsx(MessagesSquare, { width: 14, height: 14 }),
                  !collapsed &&
                    _jsx('span', {
                      className:
                        'text-sm font-bold tracking-[0.12em] uppercase',
                    ...
                    children: [
                      ...
                      filterTags.length > 0 &&
                        _jsx('button', {
                          ...
                          children: _jsx(X, { width: 10, height: 10 }),
                        }),
                    ],
                  }),
              ],
              ...
              _jsx(motion.div, {
                ...
                children:
                  sortedSessions.length === 0
                    ? _jsx('p', {
                        className:
                          'text-[10px] text-[var(--matrix-text-secondary)] text-center py-2',
                        children: collapsed
                          ? ''
                          : sessionSearchQuery
                ...
                children: [
                  ...
                  partnerError &&
                    _jsx(WifiOff, {
                      width: 12,
                      height: 12,
                      className: cn(theme.iconMuted),
                    }),
                  !partnerLoading &&
                    !partnerError &&
                    _jsx('span', {
                      className: cn('text-xs', theme.textMuted),
                      children: sortedPartnerSessions.length,
                    }),
                ],
              }),
            ],
    ...
    children: [
      ...
      _jsx('button', {
        ...
        children: sidebarCollapsed
          ? _jsx(ChevronRight, { width: 18, height: 18, strokeWidth: 2.5 })
          : _jsx(ChevronLeft, { width: 18, height: 18, strokeWidth: 2.5 }),
      }),
    ],
  });
}
