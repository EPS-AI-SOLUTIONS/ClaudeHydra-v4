  ...
  return _jsxs('footer', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx('span', {
            className: isLight ? 'text-emerald-600' : 'text-white',
            children: 'v4.0.0',
          }),
          ...
          modelTier &&
            _jsxs('div', {
              ...
              children: [
                ...
                _jsx('span', {
                  className: 'font-bold',
                  children: modelTier.label,
                }),
              ],
            }),
          _jsx('span', {
            className: isLight ? 'text-slate-700' : 'text-white/50',
            children: selectedModel,
          }),
          _jsx('span', { className: dividerCls, children: '|' }),
          _jsx('span', {
            title: t('footer.statusTagline', 'AI Swarm Control Center'),
            children: resolvedTagline,
          }),
          _jsx('span', { className: dividerCls, children: '|' }),
          _jsx('span', {
