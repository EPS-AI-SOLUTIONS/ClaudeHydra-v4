...
class ErrorBoundary extends Component {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return _jsx('div', {
        className: 'min-h-screen flex items-center justify-center bg-[var(--matrix-bg-primary)] p-6',
        children: _jsx(Card, {
          variant: 'elevated',
          padding: 'lg',
          ...
          children: _jsxs('div', {
            ...
            children: [
              _jsx('div', {
                ...
                children: _jsx(AlertTriangle, { size: 28, className: 'text-red-400' }),
              }),
              _jsxs('div', {
                children: [
                  _jsx('h2', {
                    className: 'text-lg font-bold font-mono text-[var(--matrix-text-primary)]',
              ...
              _jsx(Button, {
                variant: 'primary',
                size: 'md',
                leftIcon: _jsx(RotateCcw, { size: 16 }),
