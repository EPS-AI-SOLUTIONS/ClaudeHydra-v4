  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          session._pending
            ? _jsx(Loader2, { size: 14, className: 'shrink-0 animate-spin text-[var(--matrix-accent)]/60' })
            : _jsx(MessageSquare, { size: 14, className: 'shrink-0' }),
          _jsxs('div', {
            className: 'flex-1 min-w-0',
            children: [
              _jsx('p', {
                className: cn('text-sm truncate', session._pending && 'opacity-60 italic'),
        ...
        _jsxs('div', {
          ...
          children: [
            ...
            isActive &&
              onAddTags &&
              !showTagInput &&
              _jsx(AddTagButton, { isDark: isDark, onClick: () => setShowTagInput(true) }),
          ],
        }),
      showTagInput &&
        isActive &&
      ...
      showTooltip &&
        ...
        _jsxs('div', {
          ...
          children: [
            _jsx('p', {
              className: 'text-[11px] text-[var(--matrix-text-primary)] font-medium truncate mb-1',
              children: session.title,
            }),
            _jsx('p', {
              className: 'text-[10px] text-[var(--matrix-text-secondary)] line-clamp-3 leading-relaxed',
              children: session.preview,
            }),
            _jsxs('div', {
              className: 'flex items-center justify-between mt-1.5 pt-1.5 border-t border-[var(--matrix-border)]',
              children: [
                _jsxs('span', {
            ...
            tags.length > 0 &&
              _jsx('div', {
                className: 'flex flex-wrap gap-1 mt-1.5 pt-1 border-t border-[var(--matrix-border)]',
                children: tags.map((tag) => _jsx(TagChip, { tag: tag, isDark: isDark, size: 'xs' }, tag)),
              }),
          ],
        }),
    ],
