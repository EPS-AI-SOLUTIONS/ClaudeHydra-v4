    ...
    children: [
      _jsxs('button', {
        ...
        children: [
          ...
          _jsx('span', {
            className:
              'text-[var(--matrix-text-primary)] font-medium truncate flex-1 text-left',
          ...
          _jsxs(motion.div, {
            ...
            children: [
              models.length > 5 &&
                _jsxs('div', {
                  className:
                    'flex items-center gap-2 px-3 py-2 border-b border-[var(--glass-border)]',
                  children: [
                    _jsx(Search, {
                      width: 14,
                      height: 14,
              ...
              _jsxs('div', {
                ...
                children: [
                  filtered.length === 0 &&
                    _jsx('div', {
                      className:
                        'px-3 py-4 text-center text-sm text-[var(--matrix-text-secondary)] font-mono',
                    ...
                    return _jsxs(
                      'button',
                      {
                        ...
                        className: cn(
                          ...
                          isSelected &&
                            'border border-[var(--matrix-accent)]/30',
                        ...
                        children: [
                          ...
                          _jsxs('span', {
                            ...
                            children: [
                              _jsx('span', {
                                className:
                                  'block font-medium text-[var(--matrix-text-primary)] truncate',
                                children: model.name,
                              }),
                              model.description &&
                                _jsx('span', {
                                  className:
                                    'block text-xs text-[var(--matrix-text-secondary)] truncate mt-0.5',
                          ...
                          model.provider &&
                            _jsx('span', {
                              className:
                                'badge badge-default text-[10px] font-mono uppercase shrink-0',
