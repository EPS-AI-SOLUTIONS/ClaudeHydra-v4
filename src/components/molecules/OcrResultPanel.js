...
import { Badge, Button, Card, cn, MarkdownRenderer } from '@jaskier/ui';
          ...
          _jsxs('div', {
            ...
            children: [
              ...
              onFormatChange &&
                _jsxs('div', {
                  className:
                    'flex items-center rounded-md overflow-hidden border',
      ...
      outputFormat === 'html'
        ? showRendered
          ? _jsx('div', {
              ref: renderedRef,
              className:
                'ocr-html-content text-xs leading-relaxed max-h-96 overflow-y-auto rounded-md p-3',
              style: {
        ...
        : showRendered
          ? _jsx('div', {
              ref: renderedRef,
              className:
                'ocr-rendered text-xs leading-relaxed max-h-96 overflow-y-auto rounded-md p-3',
              style: {
                color: 'var(--matrix-text-primary)',
                backgroundColor: 'var(--matrix-bg-secondary)',
                border: '1px solid var(--matrix-border)',
              },
              children: _jsx(MarkdownRenderer, {
                content: currentText,
