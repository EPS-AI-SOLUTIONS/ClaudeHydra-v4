...
export const PromptSuggestions = memo(({ suggestions, onSelect, className }) => {
        ...
        motion.li,
        {
          ...
          children: [
            _jsx(Icon, {
              size: 18,
              className:
                'text-[var(--matrix-text-secondary)] group-hover:text-[var(--matrix-accent)] transition-colors mt-0.5 shrink-0',
            }),
            _jsx('span', {
              className:
                'text-sm font-mono text-[var(--matrix-text-secondary)] group-hover:text-[var(--matrix-text-primary)] transition-colors leading-snug',
              children: text,
            }),
          ],
        },
