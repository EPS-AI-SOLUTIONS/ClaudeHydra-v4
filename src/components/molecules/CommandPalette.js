    ...
    () => [
      {
        ...
        icon: _jsx(Home, { width: 16, height: 16 }),
      ...
      },
      {
        ...
        icon: _jsx(MessageSquare, { width: 16, height: 16 }),
      ...
      },
      {
        ...
        icon: _jsx(Plus, { width: 16, height: 16 }),
      ...
      },
      {
        ...
        icon: isLight
          ? _jsx(Moon, { width: 16, height: 16 })
          : _jsx(Sun, { width: 16, height: 16 }),
