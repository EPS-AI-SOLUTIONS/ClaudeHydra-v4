        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              ...
              _jsx('span', {
                className:
                  'text-xs font-mono text-[var(--matrix-text-secondary)] uppercase tracking-wider',
            ...
            children: [
              isArtifactLanguage &&
                ...
                _jsxs('button', {
                  ...
                  children: [
                    _jsx(Maximize2, { width: 14, height: 14 }),
                    'Open Panel',
                  ],
                }),
              _jsx('button', {
                  ...
                  children: copied
                    ? _jsxs(
                        motion.span,
                        {
                          ...
                          className:
                            'flex items-center gap-1 text-[var(--matrix-success)]',
                          children: [
                            _jsx(Check, { width: 14, height: 14 }),
                            t('common.copied'),
                          ],
                        },
                        'check',
                    ...
                    : _jsxs(
                        motion.span,
                        {
                          ...
                          className: 'flex items-center gap-1',
                          children: [
                            _jsx(Clipboard, { width: 14, height: 14 }),
                            t('common.copy'),
                          ],
                        },
                        'copy',
            ...
            showLineNumbers &&
              _jsx('div', {
                ...
                children: lines.map((_, i) =>
                  _jsx(
                    'div',
                    { className: 'leading-relaxed', children: i + 1 },
                    i,
                  ),
                ),
              }),
            _jsx('code', {
              className: cn(lang && `language-${lang}`, 'block flex-1'),
              children: code,
            }),
          ],
        }),
