...
powershell -NoProfile -WindowStyle Hidden -Command "Start-Process cmd -ArgumentList '/c \"%~dp0backend\target\release\claudehydra-backend.exe\" > \"%TEMP%\jaskier-claudehydra-backend.log\" 2>&1' -WindowStyle Hidden"
